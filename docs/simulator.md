...
- Service Map: inferred dependencies and edge health.
- Error Groups: grouped failures and example trace links.
- Deployments: deployment impact and before/after comparisons.
